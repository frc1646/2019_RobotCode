...
public class Constants {
    ...
    public static final double DRIVE_MAX_VEL = 13.0; // feet per second
    ...
    public static final double DRIVE_VEL_P = 0.03;
    ...
    public static final double TANK_LEFT_VEL_D = 0.001;
